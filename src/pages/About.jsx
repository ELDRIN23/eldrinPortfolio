...
export default function About() {
  return (
    <>
      <style>{`
        /* SAME GRID BACKGROUND AS HOME + PROJECTS */
        .bg-grid {
      ...
      <div
        id="about"
        className="min-h-screen bg-grid py-6 sm:py-12 px-4 sm:px-6 flex items-center justify-center"
      >
        <motion.div
        ...
        >
          ...
          >
            ...
            <strong>Full Stack Web Development</strong>. I specialize in
            building scalable applications with a focus on{" "}
          ...
          >
            ...
            <strong>problem-solving, adaptability, and teamwork</strong>. My
            goal is to contribute to impactful projects at leading{" "}
          ...
          >
            I am eager to apply my knowledge, learn continuously, and
            collaborate with innovative teams to create real-world solutions.
          </motion.p>
